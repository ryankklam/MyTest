...
import book.springinaction.springidol.TVSeries;
...
public class SpringInActionMain {
	...
	public static void main(String[] args) {
		...
		// //设置了init-method ，即使没有用这个bean，其实也已经加载了
		...
		TVSeries westworld = (TVSeries) ctx.getBean("Westworld");
		westworld.introduceCast();
